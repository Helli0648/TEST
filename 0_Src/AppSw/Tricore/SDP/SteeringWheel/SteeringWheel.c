...
void SteeringWheel_run_xms_c2(void)
{
	...
	SteeringWheel.canMsg1.S.lowestVoltage = OrionBms.Bms_voltage_msg.s.low_cell_voltage;
	SteeringWheel.canMsg1.S.highestTemp = OrionBms.Bms_temp_and_soc_msg.s.high_temp;
	SteeringWheel.canMsg1.S.bmsTemp = OrionBms.Bms_temp_and_soc_msg.s.bms_temp;
	SteeringWheel.canMsg1.S.soc = OrionBms.Bms_temp_and_soc_msg.s.pack_soc;
	SteeringWheel.canMsg1.S.averageTemp = OrionBms.Bms_temp_and_soc_msg.s.avg_temp;
	...
	SteeringWheel.canMsg2.S.accumulatorVoltage = OrionBms.Bms_power_limit_msg.s.pack_voltage;
